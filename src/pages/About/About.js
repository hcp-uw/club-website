...
function About(props) {
    ...
    const renderProblemStatement = () => {
        return(
        <div id={isMobile ? 'about-body-mobile-top' : 'about-body'}>
    ...
    const renderClubValues = () => {
        // return(
        // <div id={isMobile ? 'about-body-mobile2' : 'about-body2'}>
        //     <Typography className="about-title" component="h5" variant="h4" color="primary">
        //         Club Values:
        //     </Typography>
        //     <ul className="dynamic-texts">
        //         <Typography id="objective" variant="subtitle3" color="primary">Listen Loudly</Typography>
        //         <br/>
        //         <Typography id="objective" variant="subtitle3" color="primary">Freedom to Fail</Typography>
        //         <br/>
        //         <Typography id="objective" variant="subtitle3" color="primary">Turn Talk to Action</Typography>
        //         <br/>
        //         <Typography id="objective" variant="subtitle3" color="primary">Respect for all Folx</Typography>
        //     </ul>
        // </div>
        // )
        return(
