...
function About(props) {
        ...
        return (
            <div id={isMobile ? "about-body-mobile" : "about-body"}>
                ...
                <Typography
                    ...
                    textAlign="center"
                >
                    The majority of projects offered by CS coursework are solo
                    or in pairs, so future programmers miss out on the
                    invaluable experience of working in larger teams. The
                    leading motivation to do CS class projects are for grades,
                ...
                >
                    ...
                    experience on the job. However, it is also quite difficult
                    to obtain without having some prior experience.
                </Typography>
                <br />
                <Typography
                    id="objective"
        ...
        return (
            <div id={isMobile ? "about-body-mobile" : "about-body"}>
                ...
                <Typography
                    ...
                    textAlign="center"
                >
                    To create a tech internship-like environment that promotes
                    the growth and development of our club members. We provide
                    team-based programming project experience and encouraging
                    <Typography
                        component="span"
                        color="accent.main"
                        variant="subtitle1"
    ...
    const displayTeam = () => {
        ...
        return (
            <div id="about-teams">{people.map((obj) => renderPerson(obj))}</div>
        );
    };
